...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/pfzq303/wvlib'
  # s.screenshots     = 'www.example/Users/hqq/Documents/admin/code/wvlibSwift/wvlibSwift.podspec.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'pfzq303' => 'pfzq303' }
  s.source           = { :git => 'https://github.com/pfzq303/wvlib.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.source_files = 'wvLC/*.h','wvlib/Classes/**/*'
  s.vendored_libraries = 'wvLC/*.a'

  s.public_header_files = 'wvLC/**/*.h'
